...
public class CustomCreatures {
    public static int treeId, pumpkinId, spiderId;
    ...
    static void createJackOSpiderTemplate() throws NoSuchFieldException, IllegalAccessException {
        final CreatureTemplate temp = new CreatureTemplateBuilder("bdew.halloween.jackospider")
                .name("Jack O Spider")
                .description("A monstrous pumpkin that grew spider legs.")
                .modelName("model.creature.jackospider")
                .types(new int[]{
                        CreatureTypes.C_TYPE_MOVE_LOCAL,
                        CreatureTypes.C_TYPE_AGG_HUMAN,
                        CreatureTypes.C_TYPE_MONSTER,
                ...
                .deathSounds("sound.combat.death.zombie", "sound.combat.death.zombie")
                .hitSounds("sound.combat.hit.zombie", "sound.combat.hit.zombie")
                .naturalArmour(ModConfig.jackOSpiderArmor)
                .damages(ModConfig.jackOSpiderDamage, ModConfig.jackOSpiderDamage, ModConfig.jackOSpiderDamage, 0f, 0f)
                .speed(2f)
                .moveRate(1500)
                .itemsButchered(new int[]{})
                .maxHuntDist(10)
                ...
                .maxAge(200)
                .armourType(ArmourTemplate.ARMOUR_TYPE_STUDDED)
                .baseCombatRating(ModConfig.jackOSpiderCR)
                .combatDamageType((byte) 4)
                .alignment(-50f)
                .maxPercentOfCreatures(0.03f)
                .build();
        ...
        ReflectionUtil.setPrivateField(temp, ReflectionUtil.getField(CreatureTemplate.class, "corpsename"), "jackospider.");

        spiderId = temp.getTemplateId();
    }
